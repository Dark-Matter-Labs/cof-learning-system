...
const STEP1_SYSTEM_PROMPT = `You are an analysis system for the COF (Civilization Options Fund). Your task is to identify which existing nodes in the knowledge graph a new learning or signal might affect.
...
const STEP2_SYSTEM_PROMPT = `You are a strategic thinking assistant for COF (Civilization Options Fund), working at the intersection of civilisational risk, institutional design, and transition finance.
...
const STEP3_SYSTEM_PROMPT = `You are analyzing how a new learning or signal affects active resource commitments at COF (Civilization Options Fund).
